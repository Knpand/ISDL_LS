	...
	<div id="container">
		<div class="contents">
			<div class="block1">
				...
				<!-- スキャン -->
				<div class="sendform">
					<b-form-input class="sendinput sendelement" type="text" v-model="isbn_rental" @change="rental" placeholder="スキャンしてください" style="margin-bottom: 5px; height:50px;width:86%;"/>
					<b-button variant="secondary" class="btn sendelement btn-default sendbtn" v-on:click="sendrental" style="padding: 0.7rem 1.0rem;margin-left:5px;height:50px;width:100px">送信</b-button>
				</div>
				<!-- テーブル -->
		...
		<!-- スキャン -->
		<div class="sendform">
			<b-form-input class="sendinput sendelement" type="text" v-model="isbn_return" @change="bookreturn" placeholder="スキャンしてください" style="margin-bottom: 5px; height:50px;width:86%;"/>
			<b-button variant="secondary" class="btn sendelement btn-default sendbtn" v-on:click="sendreturn" style="padding: 0.7rem 1.0rem;margin-left:5px;height:50px;width:100px">送信</b-button>
		</div>
	...
	<div class="block2">
		<h1>検索</h1>
			<div class="seracharea">
				...
				<div class="lend">
					貸出可能のみ表示
					<input type="checkbox" id="checkbox" v-model="checked" name="checkbox01" style="padding: 10px">
				</div>
			</div>
		<table class="tb01">
			<thead>
